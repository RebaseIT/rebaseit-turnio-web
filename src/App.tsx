          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <a href="mailto:turnio@rebaseit.tech" className="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.facebook.com/people/Turnioapp/61578713133648/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
